...
growith_calpagos_vista     → "calendario" | "lista" (vista del Calendario de Pagos)
growith_calpagos_alert_{uid} → número de pagos vencidos/hoy/mañana (badge del sidebar; evento "gh-calpagos-alert")
